<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\about\his_lst.html";i:1564648046;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <div class="page-content">
                ...
                <div class="page-body">
<button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/about/his_add'">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th colspan="2" class="text-center">发展历程</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><?php echo $vo['titlel']; ?></td>
                                <td align="center"><?php echo $vo['titler']; ?></td>
                                <td align="center">
                                    <a href="/about/his_edit/<?php echo $vo['id']; ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '/about/his_del/<?php echo $vo['id']; ?>')" class="btn btn-danger btn-sm shiny">
