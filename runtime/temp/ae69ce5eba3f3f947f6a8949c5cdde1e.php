<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\cate\news_lst.html";i:1564648234;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新闻</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">新闻名：</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $news['name']; ?>" required="" id="name" placeholder="" name="name"  type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if($news['img'] != ''): ?>
                                <img src="__IMG__/index/<?php echo $news['img']; ?>" style="float: left;" height="50" width="100">
                                <?php else: ?>
                                暂无缩略图，请选择！
                                <?php endif; ?>
                            </div>
