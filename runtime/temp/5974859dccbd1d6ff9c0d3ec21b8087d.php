<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\test\lst.html";i:1565084761;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    <button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/test/add'"><i class="fa fa-plus"></i> Add
                    </button>
                    <div class="row">
                                                ...
                                                <tbody>
                                                    <?php if(is_array($authRuleRes) || $authRuleRes instanceof \think\Collection): $i = 0; $__LIST__ = $authRuleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$authRule): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a href="/test/edit/<?php echo $authRule['id']; ?>" class="btn btn-primary btn-sm shiny">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                                </a>
                                                                <a href="#" onClick="warning('确实要删除吗', '/test/del/<?php echo $authRule['id']; ?>')" class="btn btn-danger btn-sm shiny">
