<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\admin\lst.html";i:1564648045;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
        ...
        <li>
            ...
            <div class="page-content">
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        <li><a href="/admin">系统</a></li>
                        <li class="active">管理员</li>
                        <li class="active">管理列表</li>
                    </ul>
                </div>
                <div class="page-body">
<button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/admin/add'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                            <?php if(is_array($adminres) || $adminres instanceof \think\Collection): $i = 0; $__LIST__ = $adminres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php if($admin['id'] != 1): ?>
                                        <a href="/admin/edit/<?php echo $admin['id']; ?>" class="btn btn-primary btn-sm shiny">
                                            <i class="fa fa-edit"></i> 编辑
                                        </a>
                                        <a href="#" onClick="warning('确实要删除吗', '/admin/del/<?php echo $admin['id']; ?>')" class="btn btn-danger btn-sm shiny">
                                            <i class="fa fa-trash-o"></i> 删除
                                        </a>
                                        <?php else: ?>
                                        <div style="color: red;height: 20px;">此为系统默认管理员账号，不可更改！</div>
                                        <?php endif; ?>
                                    </td>
                                </tr>
