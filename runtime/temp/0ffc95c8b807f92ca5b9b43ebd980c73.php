<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\news\thi_lst.html";i:1564648234;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <div class="page-content">
                ...
                <div class="page-body">
<button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/news/thi_add'">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center" style="padding-top: 25px;"><a href="/news/mess/<?php echo $vo['id']; ?>"><?php echo $vo['title']; ?></td>
                                <td align="center"><img style="height: 60px;" src="__IMG__/index/<?php echo $vo['img']; ?>"></td>
                                <td align="center" style="padding-top: 25px;">
                                    <a href="/news/thi_edit/<?php echo $vo['id']; ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '/news/thi_del/<?php echo $vo['id']; ?>')" class="btn btn-danger btn-sm shiny">
