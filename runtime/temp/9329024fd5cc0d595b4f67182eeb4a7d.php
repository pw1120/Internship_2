<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\test\add.html";i:1565080618;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid">
                                    ...
                                    <option value="<?php echo $authRule['id']; ?>"><?php if($authRule['level']!=0){echo '|';} echo str_repeat('—', $authRule['level']*3)?><?php echo $authRule['title']; ?></option>
