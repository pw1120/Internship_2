<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\auth_rule\lst.html";i:1565154350;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            ...
            <div class="page-content">
                ...
                <div class="page-body">
<button type="button" tooltip="添加权限" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '/auth_rule/add'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <form action="" method="post">
                            ...
                            <tbody>
                                <?php if(is_array($authRuleRes) || $authRuleRes instanceof \think\Collection): $i = 0; $__LIST__ = $authRuleRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$authRule): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td align="center"><input name="<?php echo $authRule['id']; ?>" type="text" style="width:50px; text-align:center;" value="<?php echo $authRule['sort']; ?>"></td>
                                        <td><?php if($authRule['level']!=0){echo '|';} echo str_repeat('—', $authRule['level']*3)?><?php echo $authRule['title']; ?></td>
                                        <td><?php echo $authRule['name']; ?></td>
                                        <td align="center"><?php echo $authRule['level']+1; ?>级</td>
                                        <td align="center">
                                            <a href="/auth_rule/edit/<?php echo $authRule['id']; ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除吗', '/auth_rule/del/<?php echo $authRule['id']; ?>')" class="btn btn-danger btn-sm shiny">
                        ...
                        <div><input class="btn btn-primary btn-sm shiny" style="margin-left:171px; margin-top:10px;" type="submit" value="排序" ></div>
                    </form>
                </div>
                <div>
                </div>
