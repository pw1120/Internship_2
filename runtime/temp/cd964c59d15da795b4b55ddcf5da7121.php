<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\admin\add.html";i:1564648045;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                            ...
                            <div class="col-sm-6">
                                <select name="group_id">
                                    <?php if(is_array($authGroupRes) || $authGroupRes instanceof \think\Collection): $i = 0; $__LIST__ = $authGroupRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$authGroupRes): $mod = ($i % 2 );++$i;?>
                                        <option value="<?php echo $authGroupRes['id']; ?>"><?php echo $authGroupRes['title']; ?></option>
