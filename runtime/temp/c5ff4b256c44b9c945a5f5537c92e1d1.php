<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\cate\syno_lst.html";i:1565084946;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $introdution['title']; ?>" required="" id="title" placeholder="" name="title"  type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">英文名：</label>
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $introdution['translate']; ?>"  id="translate" placeholder="" name="translate"  type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">图片：</label>
                            <div class="col-sm-6">
                                <input style="float: left;margin-top:10px; " id="img" placeholder="" name="img" type="file">
                                <?php if($introdution['img'] != ''): ?>
                                <img src="__IMG__/index/<?php echo $introdution['img']; ?>" style="float: left;" height="50" width="100">
                                <?php else: ?>
                                暂无缩略图，请选择！
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea id="content" name="content"><?php echo $introdution['content']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
