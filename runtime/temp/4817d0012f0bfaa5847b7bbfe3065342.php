<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\contact\contact.html";i:1564648234;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $show['hello']; ?>" id="hello" placeholder="" name="hello"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">内容：</label>
                                            <div class="col-sm-6">
                                                <textarea id="content" name="content"><?php echo $show['content']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">联系人：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $show['name']; ?>" id="name" placeholder="" name="name"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">联系电话：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $show['number_1']; ?>" id="number_1" placeholder="" name="number_1"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">联系电话：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $show['number_2']; ?>" id="number_2" placeholder="" name="number_2"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">传真：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $show['fax']; ?>" id="fax" placeholder="" name="fax"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">地址：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $show['address']; ?>" id="address" placeholder="" name="address"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<script type="text/javascript">
    UE.getEditor('content',{initialFrameWidth:561,initialFrameHeight:200,});
</script>
</body></html>