<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\integrator\thi_edit.html";i:1564648234;s:82:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\top.html";i:1564639786;s:83:"C:\phpStudy\PHPTutorial\WWW\test2\public/../application/admin\view\common\left.html";i:1564648234;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">商品名字：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $solution['title']; ?>" id="title" placeholder="" name="title"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label no-padding-right">信息链接：</label>
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $solution['url']; ?>" id="url" placeholder="" name="url"  type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="type">
                                                    ...
                                                    <?php if(is_array($indexes) || $indexes instanceof \think\Collection): $i = 0; $__LIST__ = $indexes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ind): $mod = ($i % 2 );++$i;?>
                                                    <option value ="<?php echo $ind['type']; ?>" <?php if($ind['type'] == $solution['type']): ?> selected="selected" <?php endif; ?>><?php echo $ind['type']; ?></option>
                                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label style="margin-top:15px; " class="col-sm-2 control-label no-padding-right">商品图片：</label>
                                            <div class="col-sm-6">
                                                <input style="float: left;margin-top:20px; " id="img" placeholder="" name="img" type="file">
                                                <?php if($solution['img'] != ''): ?>
                                                <img src="__IMG__/index/<?php echo $solution['img']; ?>" style="float: left;" height="70" width="100">
                                                <?php else: ?>
                                                暂无缩略图，请选择！
                                                <?php endif; ?>
                                            </div>
